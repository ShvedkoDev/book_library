        ...
        <div class="header-blurb container">
            <div class="breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="Go to Micronesian Teachers Digital Library." href="{{ route('cms.page.show', 'home') }}" class="main-home">
                ...
                <aside class="sidebar" role="complementary">
                        ...
                        <div class="widget widget-categories">
                            ...
                            <ul class="category-list">
                                @foreach($page->categories as $category)
                                    <li>
                                        <a href="{{ route('cms.category.show', $category->slug) }}"
                        ...
                        <div class="widget widget-related">
                            ...
                            <ul class="related-list">
                                @foreach($relatedPages as $relatedPage)
                                    <li class="mb-3">
                                        <a href="{{ route('cms.page.show', $relatedPage->slug) }}"
                    ...
                    <div class="widget widget-quick-links">
                        ...
                        <ul class="quick-links">
                            <li><a href="{{ route('cms.category.show', 'all') }}" class="text-blue-600 hover:text-blue-800">Browse Library</a></li>
                            <li><a href="{{ route('cms.search') }}" class="text-blue-600 hover:text-blue-800">Search Resources</a></li>
                            <li><a href="{{ route('cms.page.show', 'about') }}" class="text-blue-600 hover:text-blue-800">About MTDL</a></li>
                            <li><a href="{{ route('cms.page.show', 'contribute') }}" class="text-blue-600 hover:text-blue-800">Contribute</a></li>
                        </ul>
                    </div>
...
{{--
    Commented out analytics tracking since route 'cms.api.page.view' doesn't exist
