    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div class="text-sm font-medium text-blue-800 dark:text-blue-200">Total Updated</div>
                <div class="text-2xl font-bold text-blue-900 dark:text-blue-100 mt-1">{{ $totalBooks }}</div>
            </div>
        ...
        <script>
            function downloadUpdatedReport() {
                ...
                link.setAttribute('download', 'import-updated-{{ $record->id }}.csv');
...
@else
    <div class="text-center py-8 text-gray-500 dark:text-gray-400">
        ...
        <p class="mt-2 text-sm font-medium">No books were updated during this import.</p>
    </div>
@endif
