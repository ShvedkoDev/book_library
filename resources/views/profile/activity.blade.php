...
@section('title', 'My Activity - FSM National Vernacular Language Arts (VLA) Curriculum')
@section('description', 'View your activity and interactions in the FSM National Vernacular Language Arts (VLA) Curriculum')
