...
@section('title', 'My Ratings - Activity - FSM National Vernacular Language Arts (VLA) Curriculum')
@section('description', 'View all books you have rated in the FSM National Vernacular Language Arts (VLA) Curriculum')
